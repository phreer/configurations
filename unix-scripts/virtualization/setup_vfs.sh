...
echo $vfshedexecq    | sudo tee -a /sys/class/drm/card1/iov/vf1/gt/exec_quantum_ms
echo $vfschedtimeout | sudo tee -a /sys/class/drm/card1/iov/vf1/gt/preempt_timeout_us
